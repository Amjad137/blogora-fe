  ...
  return (
    <div className='grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 px-4 lg:px-6'>
      {adminCardData.map((item, index) => (
        ...
        >
          <Card className='flex flex-col justify-between bg-primary text-primary-foreground cursor-pointer'>
            ...
            <CardContent className='p-0'>
              ...
              <CardDescription className='text-center text-base font-base text-primary-foreground mt-2'>
                {item.title}
              </CardDescription>
            </CardContent>
            ...
            <CardFooter className='items-end justify-center gap-1 text-sm p-2'>
              {item.subTitle && (
                <div className='text-primary-foreground font-extralight'>{item.subTitle}</div>
              )}
            </CardFooter>
          </Card>
        </Link>
